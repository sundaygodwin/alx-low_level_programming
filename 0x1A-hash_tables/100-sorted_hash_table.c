 ...
 *
 * Return: NULL if error else pointer to the sorted hash table.
 */
...
/**
 * shash_table_get - Retrieve the value of key of sorted hash table
 *
 * @ht: pointer to the sorted hash table.
 * @key: key to get the value.
 *
 * Return: NULL if key cannot match else the value of key.
 */
